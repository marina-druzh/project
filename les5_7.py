...
with open('task_7.txt', 'r', encoding='utf-8') as file:
    ...
    if i != 0:
        ...
        print(f'Все работают с убытком')
    profit.update({'average_profit': round(prof_aver)})

with open('task_7.json', 'w', encoding='utf-8') as write_js:
    json.dump(profit, write_js)
    js_str = json.dumps(profit, sort_keys=False, indent=4, ensure_ascii=False, separators=(',', ': '))
